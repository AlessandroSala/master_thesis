...
\begin{table}[h]
  ...
  \begin{tabular}{cccccc}
    ...
    \bottomrule
  \end{tabular}
  \caption[A typical parametrisation of the coefficients in the SEMF \eqref{eq:semf}.]{A typical parametrisation of the coefficients in the SEMF \eqref{eq:semf}. Values are taken from~\cite{Rohlf1994}.}
...
Unfortunately, unlike the atomic case, there is no external source of the field to which nucleons are sucject to, since it is generated by the nucleons themselves; nonetheless, the formulation of an empirical mean-field potential which reproduces experimental data has been proven to be successful in providing useful corrections.
...
\begin{table}[h]
  ...
  \begin{tabular}{cccccc}
    ...
    \bottomrule
  \end{tabular}
  \caption[Typical Woods--Saxon potential parameters.]{Typical Woods--Saxon potential parameters. Values are taken from~\cite{Schwierz2007}.}
