...
Since Equation~\eqref{eq:hf_energy} is valid only for $\delta E = 0$, it is useful to check its equivalence with the integrated energy at convergence, so one can be sure to actually be in a stationary point.