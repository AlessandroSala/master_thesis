...
\label{sec:ev8}
$\texttt{HFBTHO}$ can be used to judge how well our implementation behaves against other codes for deformed nuclei, but its numerical methodology is profoundly different.
