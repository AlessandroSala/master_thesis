...
\begin{table}[ht]
  ...
  \begin{tabular}{lrccccc}
    ...
    $\expval{\mathcal Q_{20}}$ &[-] & 34.981 & 33.905 & 33.881 & 0.024  & \num{7.08e-2}  \\
    \bottomrule
  \end{tabular}
...
\begin{figure}[htp]
  ...
  \caption{Comparison between the SkM* and the SLy4 Skyrme functionals of the $^{24}$Mg deformation curves, box $[-10, 10]$ fm, step size $0.6$ fm.}
