...
Spherical harmonics, of degree $\lambda$ and order $\mu$, are defined as
\begin{equation}
...
\end{equation}
All higher degrees are then generated using the standard upward recurrence relation in $\lambda$:
\begin{equation}
