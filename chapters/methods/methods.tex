...
In this thesis, we investigate such an approach through the use of the \textit{Generalized Conjugate Gradient} (GCG) method, presented in detail in section~\ref{sec:gcg}.
...
\section{Objectives}
The aim of this work is to develop a new implementation of the Hartree-Fock method on an unconstrained 3D mesh, by the use of the Generalized Conjugate Gradient method. The goals addressed by this work are the following:
\begin{itemize}
    \item assess the feasibility of the Generalized Conjugate Gradient for the solution of large-scale eigenvalue problems;
...
\paragraph{Finite Differences and Generalized Conjugate Gradient}  
