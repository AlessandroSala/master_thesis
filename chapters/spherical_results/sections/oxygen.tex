...
\begin{table}[!ht]
  ...
  \begin{tabular}{lcccc}
    ...
    $r_{\text{ch, exp}}$ (fm) & 2.699 & 3.477 & 3.750 & 4.269 \\
    \bottomrule
  \end{tabular}
  \caption{Comparison of experimental binding energies and charge radii with theoretical values using the SLy5 functional. Data taken from \cite{ANGELI201369}.}
  \label{tab:exp_comp}
\end{table}
