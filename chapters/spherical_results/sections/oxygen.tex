...
\begin{table}[ht]
  ...
  \begin{tabular}{lrcccc}
    ...
    \bottomrule
  \end{tabular}
  \caption{$^{16}$O including $C_0^{\rho}$, $C_1^{\rho}$, $C_0^{\tau}$, $C_1^{\tau}$ terms and neglecting Coulomb interaction. \explaindelta}
...
\begin{table}[ht]
  ...
  \begin{tabular}{lrcccc}
    ...
    \bottomrule
  \end{tabular}
  \caption{$^{16}$O including $C_0^\rho$, $C_1^\rho$, $C_0^\tau$, $C_1^\tau$, $C_0^{\div \bm J}$, $C_1^{\div \bm J}$ terms, neglecting the Coulomb interaction and $J^2$ terms. \explaindelta}
...
\begin{table}[ht]
  ...
  \begin{tabular}{lrcccc}
    ...
    \bottomrule
  \end{tabular}
  \caption{$^{16}$O neglecting Coulomb interaction. \explaindelta}
...
\begin{table}[ht]
  ...
  \begin{tabular}{lrcccc}
    ...
    \bottomrule
  \end{tabular}
  \caption{$^{16}$O complete of the Skyrme functional and Coulomb interaction. \explaindelta}
  \label{tab:confronto}
\end{table}
...
\begin{table}[ht]
  ...
  \begin{tabular}{lrcccc}
    ...
    \bottomrule
  \end{tabular}
  \caption{$^{48}$Ca, box size [-12, 12] fm, step size 0.34 fm. \explaindelta}
...
\begin{table}[ht]
  ...
  \begin{tabular}{lrcccc}
    ...
    \bottomrule
  \end{tabular}
  \caption{$^{56}$Ni, box size [-13, 13] fm, step size 0.37 fm. \explaindelta}
...
\begin{table}[ht]
  ...
  \begin{tabular}{lrcccc}
    ...
    \bottomrule
  \end{tabular}
  \caption{$^{90}$Zr, box size [-15, 15] fm, step size 0.43 fm. \explaindelta}
...
\begin{table}[!ht]
  ...
  \begin{tabular}{lcccc}
    ...
    \bottomrule
  \end{tabular}
  \caption{Comparison of experimental binding energies and charge radii with theoretical values using the SLy5 functional. Data taken from \cite{ANGELI201369,chabanat2}.}
  \label{tab:exp_comp}
\end{table}
