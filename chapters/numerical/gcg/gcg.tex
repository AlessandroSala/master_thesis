...
This section is devoted to the approximate solution of the eigenvalue problem, needed for the Schr"odinger equation \eqref{eq:spe_ks}. The analysis and implementation work presented was developed within the additional thesis activity carried out for the Honours Programme \emph{Scientific Research in Industrial Engineering -- Nuclear Science and Technology}.
