...
Constraints can be formulated as an equality-constrained optimisation problem (ECP), formulated as
\begin{align}
\min_{\ket \Psi}&E \nonumber
...
After finding the minimum of $E'$, it is trivial to show that for a given $\lambda$, we get \cite{FLOCARD1973433}
\begin{equation}
